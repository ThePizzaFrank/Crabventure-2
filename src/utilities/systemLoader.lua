...
Death = require("src.systems.death")
SolidCollision = require("src.systems.solidCollision")
--event systems
...
function initializeSystems()
  ...
  Systems:new(type,Death,true,false)
  Systems:new(type,SolidCollision, true, false)
